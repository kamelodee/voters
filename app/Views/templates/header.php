  ...
  <?php if (session()->get('isLoggedIn')): ?>
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item <?= ($uri->getSegment(1) == 'polling-station' ? 'active' : null) ?>">
            <a class="nav-link"  href="<?= base_url('polling-stations')?>">Polling Station</a>
          </li>
          <li class="nav-item <?= ($uri->getSegment(1) == 'users' ? 'active' : null) ?>">
            <a class="nav-link"  href="<?= base_url('users-list')?>">Users</a>
          </li>
          <li class="nav-item <?= ($uri->getSegment(1) == 'membertypes' ? 'active' : null) ?>">
            <a class="nav-link"  href="<?= base_url('membertypes')?>">Member Types</a>
          </li>
        </ul>
